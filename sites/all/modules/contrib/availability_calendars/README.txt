...
importer to do so. Note that iCalendar synchronization can only add new
bookings from one site to another. Changing dates or cancelling bookings is (as
far as  I know) not possible with just an iCalendar feed.
